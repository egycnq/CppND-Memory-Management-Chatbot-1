...
ChatLogic::~ChatLogic()
{
    /* 
    Bug catched :D
    ChatBot Not owned by ChatLogic it shouldn't be Deleted here.
    */
    // delete chatbot instance
    //  delete _chatBot;

    //We not need to Delete because the resources are managed by unique_ptr.
    // for (auto it = std::begin(_nodes); it != std::end(_nodes); ++it)
    // {
    //     delete *it;
    // }

    //ChatLogic Not own GraphEdge ****
